...
from vremenko.vreme import čas_uredi


slo_časovni_pas = tz.gettz("Europe/Ljubljana")
časi = [
    ("07.07.2020 21:00 CEST", '7. 7. 2020', '21.00',
     datetime.datetime(2020, 7, 7, 21, 0, tzinfo=slo_časovni_pas)),
    ("06.04.2020 19:38 CEST", '6. 4. 2020', '19.38',
     datetime.datetime(2020, 4, 6, 19, 38, tzinfo=slo_časovni_pas)),
    (1, None, None, None),
    (True, None, None, None),
